class SellerPanel {
    ...
    setupRealTimeListeners() {
        ...
        const statusSubscription = supabase
            ...
            .on('postgres_changes', 
                ...
                (payload) => {
                    this.updateOrderStatus(payload.new);
                }
            )
            .subscribe();
    }
    ...
    getOrderActions(order) {
        ...
        if (order.status === ORDER_STATUS.PENDING) {
            actions.push(`
                <button class="btn btn-success btn-sm" onclick="sellerPanel.updateOrderStatus('${order.id}', '${ORDER_STATUS.CONFIRMED}')">
        ...
        if (order.status === ORDER_STATUS.CONFIRMED) {
            actions.push(`
                <button class="btn btn-warning btn-sm" onclick="sellerPanel.updateOrderStatus('${order.id}', '${ORDER_STATUS.PREPARING}')">
        ...
        if (order.status === ORDER_STATUS.PREPARING) {
            actions.push(`
                <button class="btn btn-info btn-sm" onclick="sellerPanel.updateOrderStatus('${order.id}', '${ORDER_STATUS.READY}')">
